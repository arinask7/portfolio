...
|3|![Изображение](3.jpg)|Нет логина и пароля|Текст-ссылка|Активен|При нажатии открывается первая страница регистрации в Прототипах 3 и 4.|
...
|5|![Изображение](5.jpg)|Продолжение регистрации|Кнопка|Активен|При нажатии открывается вторая страница регистрации в Прототипах 3 и 4.|
|6|![Изображение](6.jpg)|Завершение регистрации|Кнопка|Активен|При нажатии открывается главная страница в Прототипах 3 и 4.|
...
|13|![Изображение](13.jpg)|Заказ|Кнопка|Активен|При нажатии появляется модальное окно с успешным выполнением операции в Прототипах 1 и 3 и с ошибкой операции в Прототипах 2 и 4.|
|14| 
|15|
|16|
|17|
