...
- *Альтернативный сценарий*:
   ...
   - Шаг 2: Пользователь отправляет сообщение боту, например, “Заказать дебетовую карту”.
   - Шаг 3: Система отображает URL в ответном сообщении на форму заказа дебетовой карты.
   - Шаг 4: Пользователь нажимает на URL.
   - Шаг 5: Система отображает экран с формой заказа дебетовой карты.
   - Шаг 6: Пользователь нажимает кнопку “Заказать”.
   - Шаг 7: Система выводит сообщение об успешном заказе карты.
   - Шаг 8: Пользователь нажимает текст-ссылку “ОК”.
   - Шаг 9: Система возвращает пользователя на главный экран.

- *Исключительный сценарий 1*:
   - Шаг 1: Пользователь нажимает кнопку “Дебетовая карта” на главном экране.
   - Шаг 2: Система отображает экран с формой заказа дебетовой карты.
   - Шаг 3: Пользователь нажимает кнопку “Заказать”.
   - Шаг 4: Система выводит пользователю уведомление об ошибке.
   - Шаг 5: Пользователь нажимает текст-ссылку “ОК”.
...
- *Исключительный сценарий 2*:
   ...
   - Шаг 5: Система отображает экран с формой заказа дебетовой карты.
   - Шаг 6: Пользователь нажимает кнопку “Заказать”.
   - Шаг 7: Система выводит пользователю уведомление об ошибке.
   - Шаг 8: Пользователь нажимает текст-ссылку “ОК”.
   - Шаг 9: Система возвращает пользователя на главный экран.

**Артефакты**

- *Сценарий 1*: "Пользователь зарегистрирован, выполняет вход и далее идет по основному или альтернативному сценарию заказа дебетовой карты":
   - Ссылка на артефакт:</br>https://figma.fun/h4cvWV

- *Сценарий 2*: "Пользователь зарегистрирован, выполняет вход и далее идет по исключительному сценарию заказа дебетовой карты 1 или 2":
   - Ссылка на артефакт:</br>https://figma.fun/rRZtQY
   
- *Сценарий 3*: "Пользователь не был зарегистрирован, проходит регистрацию и далее идет по основному или альтернативному сценарию заказа дебетовой карты":
   - Ссылка на артефакт:</br>https://figma.fun/9tlZEW

- *Сценарий 4*: "Пользователь не был зарегистрирован, проходит регистрацию и далее идет по исключительному сценарию заказа дебетовой карты 1 или 2":
   - Ссылка на артефакт:</br>https://figma.fun/T4g1wc
...
|2|![Изображение](2.jpg)|Завершение входа|Кнопка|Активен|При нажатии открывается главная страница.|
