...
|3|[Описание веб-сервиса REST API "Выдача кредита клиенту"]|Описаны:</br>-Методы;</br>-Входные и выходные параметры запросов;</br>-Валидация входных параметров;</br>-Примеры запросов и ответов;</br>-Схемы;</br>-Ответы и ошибки.|завершен|SwaggerHuB
