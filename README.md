...
|2|[Моделирование данных и процессов для сценария “Снятие наличных денег в банкомате"](https://github.com/arinask7/portfolio/tree/main/cash.md)|Разработаны:</br>-Use Case</br>-Диаграмма деятельности</br>-Диаграмма последовательности</br>-Диаграмма классов</br>-Диаграмма состояний|завершен|Draw.io</br>PlantUML|
